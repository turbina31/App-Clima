...
function buscarCiudad(valor) {
    const url = `https://api.openweathermap.org/data/2.5/weather?q=${valor}&lang=es&appid=${apiKey}&units=metric`;
    let urlMap = `https://www.google.com/maps/embed/v1/search?key=${key}&q=${valor}&maptype=roadmap&language=es`;
